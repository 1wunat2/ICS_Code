...
public void drawCharacter() {
  ...
  fill(#115BF5);
  strokeWeight(1);
  rect(xLoc, yLoc + size*.86, size*.65, size*.75, 10, 10, 10, 10);
  
  fill(255);
  strokeWeight(1);
  rect(xLoc, yLoc + size*.86, size*.25, size*.75, 10, 10, 10, 10);
  
  strokeWeight(3);
  line(xLoc - size*.175, yLoc + size, xLoc - size*.275, yLoc + size*.9);
  line(xLoc + size*.175, yLoc + size, xLoc + size*.275, yLoc + size*.9);
  //head
  fill(255);
